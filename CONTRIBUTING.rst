...
1. Fork `the repository <https://github.com/augmentedfabricationlab/robot_see_robot_do>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/robot_see_robot_do/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/robot_see_robot_do/issues>`_. If you are proposing a feature:
